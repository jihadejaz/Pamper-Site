<?php session_start(); { ?>
    ...
    <body>
        <nav class="navbar navbar-expand-md navbar-dark header" style="background:  #000000;">
            <a class="navbar-brand" style="font-weight: 200;" href="home.php">Glamify Store</a>
            ...
            <div class="collapse navbar-collapse ml-5 links" id="collapsibleNavbar">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white items" style="font-weight: 200;" href="womensproduct.php">Women's Products</a>
                    </li>
                ...
                <div class="col-sm-6">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" id='greater1000' href="filteredproducts.php?bflt>1000"> > 1000 </a>
                            <a class="dropdown-item" id='less500' href="filteredproducts.php?bflt<500">
                                < 500 </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-fluid d-flex border mt-0  p-sm-5">
                ...
                ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card" style="background-color: #e9eef2;">
                            ...
                            <a href="viewproduct.php?view=<?php echo $row['id']; ?>"><img class="card-img-top" src="<?php echo $row['img']; ?>" alt="Card image" width=""></a>
                            <div class="card-body">
                                <h4 class="card-title p-0 mt-sm-0" style='font-weight: 200;'><?php echo $row['name']; ?></h4>
                                ...
                                <!-- <button class='btn btn-primary' style='border-radius:0px; border: transparent; background-color: indigo;  font-weight: 200;'>Add to Cart</button> -->
                            </div>
                        </div>
                    </div>
