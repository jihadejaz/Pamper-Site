        ...
        <nav class="navbar navbar-expand-md navbar-dark header" style="background-color: #000000 ;">
            ...
            <div class="collapse navbar-collapse ml-5 links" id="collapsibleNavbar">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white items" style="font-weight: 200; background-color: red; " href="logout.php"><i class='fa fa-power-off'></i> </a>
                    </li>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            if (!isset($_GET['cart'])) {
                                ...
                                $data = $_GET['cart'];
                                $query = "SELECT * FROM `cartitem` where `email` = '$data'";
