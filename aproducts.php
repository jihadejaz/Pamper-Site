    ...
    <nav class="navbar navbar-expand-md navbar-dark header" style="background:  #000000;">
        ...
        <div class="collapse navbar-collapse ml-5 links" id="collapsibleNavbar">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white items" href="contactus.php">Contact Us</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white items" href="#">Privacy Policy</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white items" href="login.php">Login</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white items" href="babyproducts.php">Baby Products</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="container-fluid mt-5 d-flex ">
        <div class="row">
            ...
            if (isset($_GET['id'])) {
                ...
                $id = $_GET['id'];
                $query = "select * from `womensproduct` where name like '$id%'";
...
<?php
// $to = "jihadejaz5@gmail.com";
// $subject = "CV";
// $message = "Hi there, first time mail in PHP";
// $header = "From: jihadejaz123@gmail.com";
