...
<body>
  ...
  <nav class="navbar navbar-expand-md navbar-dark header fixed-top" style="background:  #000000;">
    <a class="navbar-brand" style="font-weight: 200;" href="addwomensproduct.php">Women's Panel</a>
  ...
  <form action="addwomensproduct.php" method='post' id="sec1" class="container" style="margin-top: 70px;" enctype="multipart/form-data">
...
if (isset($_POST['savedata'])) {
  ...
  if ($filename == '') {
    ...
    if (in_array($filecheck, $fileextstored)) {
      ...
      echo 'image uploaded';
      echo "<script>;
      window.location.href='womensproduct.php';
      </script>";


      $sql = "INSERT INTO `womensproduct` (`name`,`img`,`price`,`deletedprice`) VALUES ('$name','$destnationfile','$price','$discounted')";
      // echo $sql;
